...
------------
  ...
  python resolve_i18n_tags.py --json scripts/inav-dashboard/i18n/en.json --root src --dry-run

  # Apply replacements in-place:
  python resolve_i18n_tags.py --json scripts/inav-dashboard/i18n/en.json --root src
"""
#!/usr/bin/env python3
